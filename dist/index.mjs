 ...
 */
export function isValidCut(cutOrAction) {
 ...
 */
export function parseRawDocument(jsonDoc) {
    const guideScript = {
        contents: [],
        actSubs: {},
        backgroundSubs: {},
 ...
 */
export function parseDocument(rawList) {
    const guideScript = {
        contents: [],
        actSubs: {},
        backgroundSubs: [],
 ...
 */
export async function fetchAndParseReleaseScript(releaseScriptUrl, fetchFn) {
 ...
 */
export async function scriptMaker(scriptUrl, customGetter) {
    try {
        if (customGetter) {
 ...
 */
export async function liveClassScriptMaker(releaseScriptUrl, customGetter) {
