...
exports.dispatchLiveClassMessage = void 0;
exports.isMobileDevice = isMobileDevice;
exports.extractGuideFromMessage = extractGuideFromMessage;
exports.handleLiveClassMessage = handleLiveClassMessage;
 ...
 */
function extractGuideFromMessage(data) {
    if (!data)
        return null;
    let raw = data;
 ...
 */
async function handleLiveClassMessage(data, context, options) {
    const isMobile = (options?.platform ?? context.platform ?? (isMobileDevice() ? "mobile" : "desktop")) ===
        "mobile";
    const sleep = context.sleepFn ?? player_1.defaultSleep;
...
exports.dispatchLiveClassMessage = handleLiveClassMessage;
